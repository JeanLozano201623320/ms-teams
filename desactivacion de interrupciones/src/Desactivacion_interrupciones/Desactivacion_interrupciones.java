...
import java.util.*;
public class Desactivacion_interrupciones extends javax.swing.JFrame {

    /**
     * Creates new form CondicionesCompetencias
     */
    public Desactivacion_interrupciones() {
        initComponents();
        rc = new Rcompartido();
    ...
    private void initComponents() {
        ...
        jButton2.setText("Matar_perritos");
             ...
             try{
                switch(i){
                     case 0: 
                           ...
                           t1.sleep((long)(Math.random()*1000));
                         break;
                      case 1: 
                          t2.start();
                           
                           t2.sleep((long)(Math.random()*1000));
                         break;
                      case 2: 
                              t3.start();
                           
                           t3.sleep((long)(Math.random()*1000));
                         break;
                      case 3: 
                          t4.start();
                            
                           t4.sleep((long)(Math.random()*1000));
                         break;
                 } 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Desactivacion_interrupciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Desactivacion_interrupciones().setVisible(true);
            }
        });
    }
